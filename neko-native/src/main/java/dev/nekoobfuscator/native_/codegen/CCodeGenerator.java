    ...
    private String renderEarlyForwardDecls() {
        return """
            ...
            typedef struct NekoVmLayout {
                ...
                ptrdiff_t off_card_table_whole_heap;
                ptrdiff_t off_card_table_byte_map;
                ptrdiff_t off_card_table_byte_map_base;
                ptrdiff_t off_card_table_barrier_set_card_table;
                uintptr_t addr_barrier_set_static;
                uintptr_t card_table_byte_map_base;
                uintptr_t heap_low;
                uintptr_t heap_high;
                int card_table_card_shift;
                int card_table_dirty_card;
                int g1_young_card;
                int g1_heap_region_shift;
                ptrdiff_t off_g1_satb_mark_queue_active;
                ptrdiff_t off_g1_satb_mark_queue_index;
                ptrdiff_t off_g1_satb_mark_queue_buffer;
                ptrdiff_t off_g1_dirty_card_queue_index;
                ptrdiff_t off_g1_dirty_card_queue_buffer;
                uintptr_t jvmci_write_barrier_pre_fn;
                uintptr_t jvmci_write_barrier_post_fn;
