...
public final class Wave2FieldLdcEmitter {
    public String renderWave2Support() {
        ...
        sb.append("        if (local == NULL) { __atomic_store_n(&site->resolved_offset, NEKO_FIELD_SITE_FAILED, __ATOMIC_RELEASE); neko_wave2_capture_pending(env, thread, \"java/lang/NoClassDefFoundError\", site->owner_internal); return JNI_FALSE; }\n");
...
""");
        ...
        sb.append("    if (classClass == NULL) return NULL;\n");
        sb.append("    getClassLoader = neko_get_method_id(env, classClass, \"getClassLoader\", \"()Ljava/lang/ClassLoader;\");\n");
        sb.append("    if (getClassLoader == NULL) { neko_delete_local_ref(env, classClass); return NULL; }\n");
        ...
        sb.append("    env = neko_current_env();\n");
        sb.append("    if (env == NULL) return JNI_FALSE;\n");
        /* W0 DD-6: JVMTI GetLoadedClasses path removed — use owner_class_slot / CLD walk only */
        sb.append("    owner_class = site->owner_class_slot == NULL ? NULL : *site->owner_class_slot;\n");
        sb.append("    if (owner_class == NULL) {\n");
        sb.append("        (void)neko_throw_cached(env, g_neko_throw_le);\n");
        sb.append("        return JNI_FALSE;\n");
        ...
        sb.append("    if (klass_obj != NULL) resolved_klass = neko_class_klass_pointer(klass_obj);\n");
