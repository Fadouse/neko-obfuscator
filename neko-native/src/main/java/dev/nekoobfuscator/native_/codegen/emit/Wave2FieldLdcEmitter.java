...
public final class Wave2FieldLdcEmitter {
    public String renderWave2Support() {
        ...
        sb.append("static inline void* neko_resolve_mirror_locator_from_klass(const NekoVmLayout *layout, Klass *klass);\n");
        sb.append("static inline oop neko_resolve_mirror_oop_from_klass(const NekoVmLayout *layout, Klass *klass);\n\n");
        ...
        sb.append("                }\n");
        sb.append("            }\n");
        sb.append("            if (site->is_static && owner_klass != NULL && __atomic_load_n(&site->static_base_handle, __ATOMIC_ACQUIRE) == NULL) {\n");
        sb.append("                void *mirror_locator = neko_resolve_mirror_locator_from_klass(&g_neko_vm_layout, (Klass*)owner_klass);\n");
        sb.append("                if (mirror_locator != NULL) {\n");
        sb.append("                    __atomic_store_n(&site->static_base_handle, mirror_locator, __ATOMIC_RELEASE);\n");
        sb.append("                    neko_native_debug_log(\"cached static mirror locator %s.%s:%s -> %p\", site->owner_internal, site->field_name, site->field_desc, mirror_locator);\n");
        sb.append("                }\n");
        sb.append("            }\n");
        ...
        sb.append("    Klass *cached_klass;\n");
        sb.append("    void *mirror_locator;\n");
        sb.append("    oop mirror;\n");
        sb.append("    JNIEnv *env;\n");
        sb.append("    if (!neko_ensure_field_site_resolved(thread, site)) return NULL;\n");
        sb.append("    env = neko_current_env();\n");
        sb.append("    cached_klass = (Klass*)__atomic_load_n(&site->cached_klass, __ATOMIC_ACQUIRE);\n");
        sb.append("    if (cached_klass == NULL) {\n");
        sb.append("        if (env != NULL) neko_wave2_capture_pending(env, thread, \"java/lang/IllegalStateException\", \"missing cached klass for static field site\");\n");
        sb.append("        return NULL;\n");
        sb.append("    }\n");
        sb.append("    mirror_locator = __atomic_load_n(&site->static_base_handle, __ATOMIC_ACQUIRE);\n");
        sb.append("    if (mirror_locator == NULL) {\n");
        sb.append("        mirror_locator = neko_resolve_mirror_locator_from_klass(&g_neko_vm_layout, cached_klass);\n");
        sb.append("        if (mirror_locator != NULL) __atomic_store_n(&site->static_base_handle, mirror_locator, __ATOMIC_RELEASE);\n");
        sb.append("    }\n");
        sb.append("    mirror = neko_resolve_mirror_oop_from_klass(&g_neko_vm_layout, cached_klass);\n");
        ...
        sb.append("        return NULL;\n");
        sb.append("    }\n");
        sb.append("    neko_native_debug_log(\"static field mirror resolved (owner=%s.%s:%s, jdk_major=%d, double_deref=%s, klass=%p, locator=%p, mirror=%p)\", site->owner_internal, site->field_name, site->field_desc, g_neko_vm_layout.java_spec_version, g_neko_vm_layout.java_spec_version >= 9 ? \"yes\" : \"no\", cached_klass, mirror_locator, mirror);\n");
