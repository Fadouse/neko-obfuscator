...
public final class Wave2FieldLdcEmitter {
    public String renderWave2Support() {
        ...
        sb.append("    cached_holder = __atomic_load_n(&site->static_base_handle, __ATOMIC_ACQUIRE);\n");
        sb.append("    if (cached_holder == NULL) {\n");
        ...
        sb.append("        if (owner_klass == NULL) return NULL;\n");
        sb.append("        __atomic_store_n(&site->static_base_handle, owner_klass, __ATOMIC_RELEASE);\n");
        sb.append("        cached_holder = owner_klass;\n");
        sb.append("        neko_native_debug_log(\"cached static holder %s.%s:%s klass=%p\", site->owner_internal, site->field_name, site->field_desc, owner_klass);\n");
        sb.append("    }\n");
        sb.append("    return neko_rt_static_base_from_holder_nosafepoint((Klass*)cached_holder);\n");
        sb.append("}\n\n");
