...
static jclass g_cls_0 = NULL;   // org/example/Main$2
static jclass g_cls_1 = NULL;   // org/example/Main$Circle
static jclass g_cls_2 = NULL;   // org/example/Main$CloneThing
static jclass g_cls_3 = NULL;   // org/example/Main$Point
static jclass g_cls_4 = NULL;   // org/example/Main$Rectangle
static jclass g_cls_5 = NULL;   // org/example/Main$Triangle
static jclass g_cls_6 = NULL;   // org/example/Main
static jmethodID g_mid_0 = NULL;   // org/example/Main$Triangle.a()D/V
static jmethodID g_mid_1 = NULL;   // org/example/Main$Triangle.b()D/V
static jmethodID g_mid_2 = NULL;   // org/example/Main$Triangle.c()D/V
static jboolean g_owner_bound_0 = JNI_FALSE;   // org/example/Main$2
static jboolean g_owner_bound_1 = JNI_FALSE;   // org/example/Main$Circle
static jboolean g_owner_bound_2 = JNI_FALSE;   // org/example/Main$CloneThing
static jboolean g_owner_bound_3 = JNI_FALSE;   // org/example/Main$Point
static jboolean g_owner_bound_4 = JNI_FALSE;   // org/example/Main$Rectangle
static jboolean g_owner_bound_5 = JNI_FALSE;   // org/example/Main$Triangle
static jboolean g_owner_bound_6 = JNI_FALSE;   // org/example/Main
static neko_icache_site neko_icache_6_0_0 = {0};   // org/example/Main :: org/example/Main#isValidTriangle(Lorg/example/Main$Triangle;)Z [site 0]
static neko_icache_site neko_icache_6_0_1 = {0};   // org/example/Main :: org/example/Main#isValidTriangle(Lorg/example/Main$Triangle;)Z [site 1]
static neko_icache_site neko_icache_6_0_2 = {0};   // org/example/Main :: org/example/Main#isValidTriangle(Lorg/example/Main$Triangle;)Z [site 2]
...
#define NEKO_MANIFEST_STORAGE_COUNT 17u

#define NEKO_SIGNATURE_STORAGE_COUNT 9u
#define NEKO_SIGNATURE_MAX_ARGS 5u
...
const uint32_t g_neko_signature_descriptor_count = 9u;
...
extern void neko_sig_5_i2i(void);
extern void neko_sig_5_c2i(void);
extern void neko_sig_6_i2i(void);
extern void neko_sig_6_c2i(void);
extern void neko_sig_7_i2i(void);
extern void neko_sig_7_c2i(void);
extern void neko_sig_8_i2i(void);
extern void neko_sig_8_c2i(void);
...
static const uint8_t g_neko_utf8_0_0[] = {0x61, 0x6E, 0x6F, 0x6E, 0x2D, 0x73, 0x75, 0x70};
static NekoManifestLdcSite g_neko_ldc_sites_0[1] = {
    { 0u, 0u, NEKO_LDC_KIND_STRING, 0u, 0u, g_neko_utf8_0_0, 8u, NULL, NULL }
};
static NekoManifestFieldSite g_neko_field_sites_1[1] = {
    { 1u, "org/example/Main$Circle", "r", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_2[2] = {
    { 2u, "org/example/Main$CloneThing", "x", "I", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED },
    { 2u, "org/example/Main$CloneThing", "x", "I", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_3[1] = {
    { 2u, "org/example/Main$CloneThing", "x", "I", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_4[1] = {
    { 3u, "org/example/Main$Point", "x", "I", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_5[1] = {
    { 3u, "org/example/Main$Point", "y", "I", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_6[1] = {
    { 4u, "org/example/Main$Rectangle", "w", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_7[1] = {
    { 4u, "org/example/Main$Rectangle", "h", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_8[1] = {
    { 5u, "org/example/Main$Triangle", "a", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_9[1] = {
    { 5u, "org/example/Main$Triangle", "b", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestFieldSite g_neko_field_sites_10[1] = {
    { 5u, "org/example/Main$Triangle", "c", "D", 0u, 0u, 0u, 0u, NULL, -1, NEKO_FIELD_SITE_UNRESOLVED }
};
static NekoManifestInvokeSite g_neko_invoke_sites_11[3] = {
    { "org/example/Main$Triangle", "a", "()D", 182u, 0u, 1u, NULL },
    { "org/example/Main$Triangle", "b", "()D", 182u, 0u, 1u, NULL },
    { "org/example/Main$Triangle", "c", "()D", 182u, 0u, 1u, NULL }
};

static const char* const g_neko_manifest_owners[7] = {
    "org/example/Main$2",
    "org/example/Main$Circle",
    "org/example/Main$CloneThing",
    "org/example/Main$Point",
    "org/example/Main$Rectangle",
    "org/example/Main$Triangle",
    "org/example/Main"
};
static NekoManifestInvokeSite* const g_neko_manifest_invoke_sites[3] = {
    &g_neko_invoke_sites_11[0],
    &g_neko_invoke_sites_11[1],
    &g_neko_invoke_sites_11[2]
};

__attribute__((visibility("hidden"))) const NekoManifestMethod g_neko_manifest_methods[NEKO_MANIFEST_STORAGE_COUNT] = {
    { "org/example/Main$2", "get", "()Ljava/lang/String;", 0xE316AECEu, 0x1BBD01CEu, 0x0000u, 0u, 0u, (void*)&neko_impl_0, NULL, NULL, 0u, 0u, g_neko_ldc_sites_0, 1u, 0u },
    { "org/example/Main$Circle", "r", "()D", 0x475F176Cu, 0xA04E1CA0u, 0x0002u, 0u, 1u, (void*)&neko_impl_1, NULL, g_neko_field_sites_1, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$CloneThing", "equals", "(Ljava/lang/Object;)Z", 0x652A96AFu, 0xE2FEC579u, 0x0000u, 0u, 2u, (void*)&neko_impl_2, NULL, g_neko_field_sites_2, 2u, 0u, NULL, 0u, 0u },
    { "org/example/Main$CloneThing", "hashCode", "()I", 0x652A96AFu, 0x6C615E66u, 0x0000u, 0u, 3u, (void*)&neko_impl_3, NULL, g_neko_field_sites_3, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Point", "x", "()I", 0xE276E33Eu, 0x3442CBE9u, 0x0002u, 0u, 3u, (void*)&neko_impl_4, NULL, g_neko_field_sites_4, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Point", "y", "()I", 0xE276E33Eu, 0x690E6412u, 0x0002u, 0u, 3u, (void*)&neko_impl_5, NULL, g_neko_field_sites_5, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Rectangle", "w", "()D", 0xF7F6F4BDu, 0x99F0D303u, 0x0002u, 0u, 1u, (void*)&neko_impl_6, NULL, g_neko_field_sites_6, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Rectangle", "h", "()D", 0xF7F6F4BDu, 0x9A82F40Au, 0x0002u, 0u, 1u, (void*)&neko_impl_7, NULL, g_neko_field_sites_7, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Triangle", "a", "()D", 0x86D886ACu, 0x9CF1C369u, 0x0002u, 0u, 1u, (void*)&neko_impl_8, NULL, g_neko_field_sites_8, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Triangle", "b", "()D", 0x86D886ACu, 0xFC2C0430u, 0x0002u, 0u, 1u, (void*)&neko_impl_9, NULL, g_neko_field_sites_9, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main$Triangle", "c", "()D", 0x86D886ACu, 0xD218B8F7u, 0x0002u, 0u, 1u, (void*)&neko_impl_10, NULL, g_neko_field_sites_10, 1u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "isValidTriangle", "(Lorg/example/Main$Triangle;)Z", 0x6CD86C7Cu, 0x5D677CD8u, 0x0003u, 0u, 2u, (void*)&neko_impl_11, NULL, NULL, 0u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "hiddenAdd", "(II)I", 0x6CD86C7Cu, 0x6D47C014u, 0x0002u, 0u, 4u, (void*)&neko_impl_12, NULL, NULL, 0u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "doTinyWork", "(II)J", 0x6CD86C7Cu, 0x2A0E568Eu, 0x0003u, 0u, 5u, (void*)&neko_impl_13, NULL, NULL, 0u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "lambda$mmulVirtualThreads$15", "([[DII[[D[[D)Ljava/lang/Void;", 0x6CD86C7Cu, 0xF80AF173u, 0x0003u, 0u, 6u, (void*)&neko_impl_14, NULL, NULL, 0u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "lambda$mmulParallelStream$14", "([[DI[[D[[DI)V", 0x6CD86C7Cu, 0x2B566142u, 0x0003u, 0u, 7u, (void*)&neko_impl_15, NULL, NULL, 0u, 0u, NULL, 0u, 0u },
    { "org/example/Main", "lambda$main$3", "(I)I", 0x6CD86C7Cu, 0x7017F25Bu, 0x0003u, 0u, 8u, (void*)&neko_impl_16, NULL, NULL, 0u, 0u, NULL, 0u, 0u }
};
__attribute__((visibility("hidden"))) const uint32_t g_neko_manifest_method_count = 17u;
...
static const uint32_t g_neko_manifest_owner_count = 7u;
static const uint32_t g_neko_manifest_field_site_count = 11u;
static const uint32_t g_neko_manifest_invoke_site_count = 3u;
static const uint32_t g_neko_manifest_ldc_string_site_count = 1u;
...
#define NEKO_STRING_INTERN_SLOT_COUNT 1u
#define NEKO_STRING_INTERN_BUCKET_COUNT 2u
...
typedef void* (*neko_sig_0_static_fn)(void);
__attribute__((visibility("hidden"))) void* neko_sig_0_dispatch_static(const NekoManifestMethod* entry) {
    return ((neko_sig_0_static_fn)entry->impl_fn)();
}

typedef void* (*neko_sig_0_instance_fn)(void*);
__attribute__((visibility("hidden"))) void* neko_sig_0_dispatch_instance(const NekoManifestMethod* entry, void* _this) {
    return ((neko_sig_0_instance_fn)entry->impl_fn)(_this);
}

typedef double (*neko_sig_1_static_fn)(void);
__attribute__((visibility("hidden"))) double neko_sig_1_dispatch_static(const NekoManifestMethod* entry) {
    return ((neko_sig_1_static_fn)entry->impl_fn)();
}

typedef double (*neko_sig_1_instance_fn)(void*);
__attribute__((visibility("hidden"))) double neko_sig_1_dispatch_instance(const NekoManifestMethod* entry, void* _this) {
    return ((neko_sig_1_instance_fn)entry->impl_fn)(_this);
}

typedef int32_t (*neko_sig_2_static_fn)(void*);
__attribute__((visibility("hidden"))) int32_t neko_sig_2_dispatch_static(const NekoManifestMethod* entry, void* p0) {
    return ((neko_sig_2_static_fn)entry->impl_fn)(p0);
}

typedef int32_t (*neko_sig_2_instance_fn)(void*, void*);
__attribute__((visibility("hidden"))) int32_t neko_sig_2_dispatch_instance(const NekoManifestMethod* entry, void* _this, void* p0) {
    return ((neko_sig_2_instance_fn)entry->impl_fn)(_this, p0);
}

typedef int32_t (*neko_sig_3_static_fn)(void);
__attribute__((visibility("hidden"))) int32_t neko_sig_3_dispatch_static(const NekoManifestMethod* entry) {
    return ((neko_sig_3_static_fn)entry->impl_fn)();
}

typedef int32_t (*neko_sig_3_instance_fn)(void*);
__attribute__((visibility("hidden"))) int32_t neko_sig_3_dispatch_instance(const NekoManifestMethod* entry, void* _this) {
    return ((neko_sig_3_instance_fn)entry->impl_fn)(_this);
}

typedef int32_t (*neko_sig_4_static_fn)(int32_t, int32_t);
__attribute__((visibility("hidden"))) int32_t neko_sig_4_dispatch_static(const NekoManifestMethod* entry, int32_t p0, int32_t p1) {
    return ((neko_sig_4_static_fn)entry->impl_fn)(p0, p1);
}

typedef int32_t (*neko_sig_4_instance_fn)(void*, int32_t, int32_t);
__attribute__((visibility("hidden"))) int32_t neko_sig_4_dispatch_instance(const NekoManifestMethod* entry, void* _this, int32_t p0, int32_t p1) {
    return ((neko_sig_4_instance_fn)entry->impl_fn)(_this, p0, p1);
}

typedef int64_t (*neko_sig_5_static_fn)(int32_t, int32_t);
__attribute__((visibility("hidden"))) int64_t neko_sig_5_dispatch_static(const NekoManifestMethod* entry, int32_t p0, int32_t p1) {
    return ((neko_sig_5_static_fn)entry->impl_fn)(p0, p1);
}

typedef int64_t (*neko_sig_5_instance_fn)(void*, int32_t, int32_t);
__attribute__((visibility("hidden"))) int64_t neko_sig_5_dispatch_instance(const NekoManifestMethod* entry, void* _this, int32_t p0, int32_t p1) {
    return ((neko_sig_5_instance_fn)entry->impl_fn)(_this, p0, p1);
}

typedef void* (*neko_sig_6_static_fn)(void*, int32_t, int32_t, void*, void*);
__attribute__((visibility("hidden"))) void* neko_sig_6_dispatch_static(const NekoManifestMethod* entry, void* p0, int32_t p1, int32_t p2, void* p3, void* p4) {
    return ((neko_sig_6_static_fn)entry->impl_fn)(p0, p1, p2, p3, p4);
}

typedef void* (*neko_sig_6_instance_fn)(void*, void*, int32_t, int32_t, void*, void*);
__attribute__((visibility("hidden"))) void* neko_sig_6_dispatch_instance(const NekoManifestMethod* entry, void* _this, void* p0, int32_t p1, int32_t p2, void* p3, void* p4) {
    return ((neko_sig_6_instance_fn)entry->impl_fn)(_this, p0, p1, p2, p3, p4);
}

typedef void (*neko_sig_7_static_fn)(void*, int32_t, void*, void*, int32_t);
__attribute__((visibility("hidden"))) void neko_sig_7_dispatch_static(const NekoManifestMethod* entry, void* p0, int32_t p1, void* p2, void* p3, int32_t p4) {
    ((neko_sig_7_static_fn)entry->impl_fn)(p0, p1, p2, p3, p4);
    return;
}

typedef void (*neko_sig_7_instance_fn)(void*, void*, int32_t, void*, void*, int32_t);
__attribute__((visibility("hidden"))) void neko_sig_7_dispatch_instance(const NekoManifestMethod* entry, void* _this, void* p0, int32_t p1, void* p2, void* p3, int32_t p4) {
    ((neko_sig_7_instance_fn)entry->impl_fn)(_this, p0, p1, p2, p3, p4);
    return;
}

typedef int32_t (*neko_sig_8_static_fn)(int32_t);
__attribute__((visibility("hidden"))) int32_t neko_sig_8_dispatch_static(const NekoManifestMethod* entry, int32_t p0) {
    return ((neko_sig_8_static_fn)entry->impl_fn)(p0);
}

typedef int32_t (*neko_sig_8_instance_fn)(void*, int32_t);
__attribute__((visibility("hidden"))) int32_t neko_sig_8_dispatch_instance(const NekoManifestMethod* entry, void* _this, int32_t p0) {
    return ((neko_sig_8_instance_fn)entry->impl_fn)(_this, p0);
}
...
static void neko_bind_owner_6(JNIEnv *env, jclass self_class) {
    ...
    neko_bind_class_slot(env, &g_cls_5, "org/example/Main$Triangle");
    neko_bind_method_slot(env, &g_mid_0, g_cls_5, "org/example/Main$Triangle", "a", "()D", JNI_FALSE);
    neko_bind_method_slot(env, &g_mid_1, g_cls_5, "org/example/Main$Triangle", "b", "()D", JNI_FALSE);
    neko_bind_method_slot(env, &g_mid_2, g_cls_5, "org/example/Main$Triangle", "c", "()D", JNI_FALSE);
}
...
static jvalue neko_icache_stub_6_0_0(JNIEnv *env, jobject receiver, const jvalue *args) {
    jvalue result = {0};
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(8u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); return result; }
    result.d = neko_impl_8(receiver);
    return result;
}

static jvalue neko_icache_stub_6_0_1(JNIEnv *env, jobject receiver, const jvalue *args) {
    jvalue result = {0};
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(9u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); return result; }
    result.d = neko_impl_9(receiver);
    return result;
}

static jvalue neko_icache_stub_6_0_2(JNIEnv *env, jobject receiver, const jvalue *args) {
    jvalue result = {0};
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(10u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); return result; }
    result.d = neko_impl_10(receiver);
    return result;
}
...
__attribute__((used, visibility("default"))) void* neko_impl_0(void* _this) {
    JNIEnv *env = NULL;
    ...
    locals[0].o = _this;
L0: ;
    { void *__ldc = neko_ldc_string_site_oop(env, &g_neko_ldc_sites_0[0]); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_O(__ldc); }
    return (void*)POP_O();
L1: ;
...
__attribute__((used, visibility("default"))) double neko_impl_1(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_1[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
...
__attribute__((used, visibility("default"))) int32_t neko_impl_2(void* _this, void* p0) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[1].o);
    { jobject __obj = POP_O(); jboolean __match = JNI_FALSE; if (__obj != NULL) { jclass __target = neko_bound_class(env, g_cls_2, "org/example/Main$CloneThing"); if (__target == NULL) goto __neko_exception_exit; __match = neko_is_instance_of(env, __obj, __target); } PUSH_I(__match ? 1 : 0); }
    if (POP_I() == 0) goto L2;
    PUSH_O(locals[1].o);
    { jobject __obj = POP_O(); if (__obj != NULL) { jclass __target = neko_bound_class(env, g_cls_2, "org/example/Main$CloneThing"); if (__target == NULL) goto __neko_exception_exit; if (!neko_is_instance_of(env, __obj, __target)) { (void)neko_throw_cached(env, g_neko_throw_cce); goto __neko_exception_exit; } } PUSH_O(__obj); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    locals[2].o = POP_O();
L1: ;
    PUSH_O(locals[2].o);
    ...
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_2[1]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_I(neko_field_read_I(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
...
__attribute__((used, visibility("default"))) int32_t neko_impl_3(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
__attribute__((used, visibility("default"))) int32_t neko_impl_4(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_4[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_I(neko_field_read_I(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_I();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) int32_t neko_impl_5(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_5[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_I(neko_field_read_I(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_I();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) double neko_impl_6(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_6[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_D();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) double neko_impl_7(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_7[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_D();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) double neko_impl_8(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_8[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_D();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) double neko_impl_9(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_9[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_D();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) double neko_impl_10(void* _this) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L0: ;
    PUSH_O(locals[0].o);
    { NekoManifestFieldSite *__site = &g_neko_field_sites_10[0]; void *__recv = POP_O(); if (__recv == NULL) { neko_raise_null_pointer_exception(thread); goto __neko_exception_exit; } if (!neko_ensure_field_site_resolved(thread, __site)) goto __neko_exception_exit; PUSH_D(neko_field_read_D(__recv, __site)); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    return POP_D();
L1: ;
__neko_exception_exit: ;
...
__attribute__((used, visibility("default"))) int32_t neko_impl_11(void* p0) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
    ...
    NEKO_TRACE(2, "[nk] e idx=%d sig=\"%s\"\n", 11, "(Lorg/example/Main$Triangle;)Z");
    neko_slot stack[32];
    int sp = 0;
    neko_slot locals[15];
    memset(locals, 0, sizeof(locals));
...
L0: ;
    PUSH_O(locals[0].o);
    { jvalue * __args = NULL; jobject __recv = POP_O(); if (__recv == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jmethodID mid = neko_bound_method(env, g_mid_0, "org/example/Main$Triangle", "a", "()D", JNI_FALSE); if (mid == NULL) goto __neko_exception_exit; NekoManifestInvokeSite *__vsite = &g_neko_invoke_sites_11[0]; void *__vmethod = neko_resolve_invoke_site(__vsite); if (__vmethod != NULL && neko_vtable_inline_supported(__recv, __vmethod, JNI_FALSE)) { if (!neko_manifest_method_active(8u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); goto __neko_exception_exit; } jdouble __vt_result = neko_impl_8(__recv); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__vt_result); } else { jvalue __ic_result = neko_icache_dispatch(env, &neko_icache_6_0_0, &neko_icache_meta_6_0_0, __recv, mid, __args); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__ic_result.d); } }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    locals[1].d = POP_D();
L1: ;
    PUSH_O(locals[0].o);
    { jvalue * __args = NULL; jobject __recv = POP_O(); if (__recv == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jmethodID mid = neko_bound_method(env, g_mid_1, "org/example/Main$Triangle", "b", "()D", JNI_FALSE); if (mid == NULL) goto __neko_exception_exit; NekoManifestInvokeSite *__vsite = &g_neko_invoke_sites_11[1]; void *__vmethod = neko_resolve_invoke_site(__vsite); if (__vmethod != NULL && neko_vtable_inline_supported(__recv, __vmethod, JNI_FALSE)) { if (!neko_manifest_method_active(9u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); goto __neko_exception_exit; } jdouble __vt_result = neko_impl_9(__recv); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__vt_result); } else { jvalue __ic_result = neko_icache_dispatch(env, &neko_icache_6_0_1, &neko_icache_meta_6_0_1, __recv, mid, __args); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__ic_result.d); } }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    locals[3].d = POP_D();
L2: ;
    PUSH_O(locals[0].o);
    { jvalue * __args = NULL; jobject __recv = POP_O(); if (__recv == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jmethodID mid = neko_bound_method(env, g_mid_2, "org/example/Main$Triangle", "c", "()D", JNI_FALSE); if (mid == NULL) goto __neko_exception_exit; NekoManifestInvokeSite *__vsite = &g_neko_invoke_sites_11[2]; void *__vmethod = neko_resolve_invoke_site(__vsite); if (__vmethod != NULL && neko_vtable_inline_supported(__recv, __vmethod, JNI_FALSE)) { if (!neko_manifest_method_active(10u)) { neko_raise_cached_pending(thread, g_neko_throw_loader_linkage); goto __neko_exception_exit; } jdouble __vt_result = neko_impl_10(__recv); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__vt_result); } else { jvalue __ic_result = neko_icache_dispatch(env, &neko_icache_6_0_2, &neko_icache_meta_6_0_2, __recv, mid, __args); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_D(__ic_result.d); } }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    locals[5].d = POP_D();
L3: ;
    PUSH_D(locals[1].d);
...
__attribute__((used, visibility("default"))) int32_t neko_impl_12(void* _this, int32_t p0, int32_t p1) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
__attribute__((used, visibility("default"))) int64_t neko_impl_13(int32_t p0, int32_t p1) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
...
L2: ;
    PUSH_I(locals[4].i);
    PUSH_I(locals[1].i);
    { jint b = POP_I(); jint a = POP_I(); if (a >= b) goto L3; }
    PUSH_L(locals[2].j);
    PUSH_L(1664525LL);
...
__attribute__((used, visibility("default"))) void* neko_impl_14(void* p0, int32_t p1, int32_t p2, void* p3, void* p4) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
    ...
    env = neko_current_env();
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(14u)) {
        neko_raise_cached_pending(thread, g_neko_throw_loader_linkage);
        return NULL;
    }
    NEKO_TRACE(2, "[nk] e idx=%d sig=\"%s\"\n", 14, "([[DII[[D[[D)Ljava/lang/Void;");
    if (env != NULL) neko_ensure_local_capacity(env, 8192);
    neko_slot stack[32];
    int sp = 0;
    neko_slot locals[18];
    memset(locals, 0, sizeof(locals));
...
L0: ;
    PUSH_O(locals[0].o);
    PUSH_I(locals[1].i);
    { jint __idx = POP_I(); jobjectArray __a = (jobjectArray)POP_O(); if (__a == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jsize __len = neko_get_array_length(env, (jarray)__a); if ((jint)__len <= __idx || __idx < 0) { (void)neko_throw_cached(env, g_neko_throw_aioobe); goto __neko_exception_exit; }  jobject __value = neko_get_object_array_element(env, __a, __idx); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_O(__value); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    locals[5].o = POP_O();
L1: ;
    PUSH_I(0);
...
L2: ;
    PUSH_I(locals[6].i);
    PUSH_I(locals[2].i);
    { jint b = POP_I(); jint a = POP_I(); if (a >= b) goto L8; }
L3: ;
    PUSH_D(0.0);
    locals[7].d = POP_D();
L4: ;
...
L5: ;
    PUSH_I(locals[9].i);
    PUSH_I(locals[2].i);
    { jint b = POP_I(); jint a = POP_I(); if (a >= b) goto L6; }
    PUSH_D(locals[7].d);
    PUSH_O(locals[3].o);
    PUSH_I(locals[1].i);
    { jint __idx = POP_I(); jobjectArray __a = (jobjectArray)POP_O(); if (__a == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jsize __len = neko_get_array_length(env, (jarray)__a); if ((jint)__len <= __idx || __idx < 0) { (void)neko_throw_cached(env, g_neko_throw_aioobe); goto __neko_exception_exit; }  jobject __value = neko_get_object_array_element(env, __a, __idx); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_O(__value); }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    PUSH_I(locals[9].i);
    { jint __idx = POP_I(); jdoubleArray __a = (jdoubleArray)POP_O(); if (__a == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jsize __len = neko_get_array_length(env, (jarray)__a); if ((jint)__len <= __idx || __idx < 0) { (void)neko_throw_cached(env, g_neko_throw_aioobe); goto __neko_exception_exit; } PUSH_D(neko_fast_daload(env, __a, __idx)); /* fallback: neko_get_double_array_region */ }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
    PUSH_O(locals[4].o);
    PUSH_I(locals[9].i);
    { jint __idx = POP_I(); jobjectArray __a = (jobjectArray)POP_O(); if (__a == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jsize __len = neko_get_array_length(env, (jarray)__a); if ((jint)__len <= __idx || __idx < 0) { (void)neko_throw_cached(env, g_neko_throw_aioobe); goto __neko_exception_exit; }  jobject __value = neko_get_object_array_element(env, __a, __idx); if (neko_pending_exception(thread) != NULL) goto __neko_exception_exit; PUSH_O(__value); }
...
L6: ;
    ...
    PUSH_I(locals[6].i);
    PUSH_D(locals[7].d);
    { jdouble __value = POP_D(); jint __idx = POP_I(); jdoubleArray __a = (jdoubleArray)POP_O(); if (__a == NULL) { (void)neko_throw_cached(env, g_neko_throw_npe); goto __neko_exception_exit; } jsize __len = neko_get_array_length(env, (jarray)__a); if ((jint)__len <= __idx || __idx < 0) { (void)neko_throw_cached(env, g_neko_throw_aioobe); goto __neko_exception_exit; } neko_fast_dastore(env, __a, __idx, __value); /* fallback: neko_set_double_array_region */ }
    if (neko_pending_exception(thread) != NULL) { goto __neko_exception_exit; }
L7: ;
    locals[6].i += 1;
    goto L2;
...
__attribute__((used, visibility("default"))) void neko_impl_15(void* p0, int32_t p1, void* p2, void* p3, int32_t p4) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
    ...
    env = neko_current_env();
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(15u)) {
        neko_raise_cached_pending(thread, g_neko_throw_loader_linkage);
        return;
    }
    NEKO_TRACE(2, "[nk] e idx=%d sig=\"%s\"\n", 15, "([[DI[[D[[DI)V");
...
__attribute__((used, visibility("default"))) int32_t neko_impl_16(int32_t p0) {
    JNIEnv *env = NULL;
    if (!neko_loader_ready()) {
        env = neko_current_env();
        (void)neko_throw_cached(env, g_neko_throw_loader_linkage);
    ...
    env = neko_current_env();
    void *thread = neko_get_current_thread();
    if (!neko_manifest_method_active(16u)) {
        neko_raise_cached_pending(thread, g_neko_throw_loader_linkage);
        return 0;
    }
    NEKO_TRACE(2, "[nk] e idx=%d sig=\"%s\"\n", 16, "(I)I");
